...
Click on this link to see the front end of this project [hello-react-front-end](https://github.com/RaphDasilva/hello-react-front-end).
...
```sh
 git clone https://github.com/RaphDasilva/hello-react-back-end
```
...
Feel free to check the [issues page](https://github.com/RaphDasilva/hello-rails-back-end/issues).
